...
const ResumeSection = () => {
    ...
    return (
        <div id="resume" className="container section-container">
            <a href="https://drive.google.com/file/d/1AU0LlGn73lHmY5oXyjYZXBp6DabL5yjs/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-decoration-none">
