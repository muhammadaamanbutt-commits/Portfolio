...
const ResumeSection = () => {
    ...
    return (
        <div id="resume" className="container section-container">
            <a href="https://drive.google.com/file/d/1N99IPJY_GBmN_mOhqpTAod7VqH71ydHt/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-decoration-none">
